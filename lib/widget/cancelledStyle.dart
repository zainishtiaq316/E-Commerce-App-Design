...
class cancelledStyle extends StatefulWidget {
  const cancelledStyle({
    Key? key,
  }) : super(key: key);

  @override
  _cancelledStyleState createState() => _cancelledStyleState();
}

class _cancelledStyleState extends State<cancelledStyle> {
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return SizedBox(
            ...
            child: myOrderedCard(
              orders: odersDetailsCanceled[index],
            ),
          );
        },
        ...
        itemCount: odersDetailsCanceled.length,
      ),
    );
  }
}
